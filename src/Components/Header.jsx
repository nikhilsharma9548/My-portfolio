...
const Header = () => {
  return (
    <section className="fixed flex h-28  w-full justify-between shadow-lg bg-gradient-to-r from-gray-200 to-gray-700 text-black font-serif px-4">

      <div className=" flex justify-center items-center gap-5">
      <img
            src={images}
            alt="logo"
            className="w-24 h-24 items-center rounded-full shadow-xl mx-5 object-cover"
          /> <h1 className=" text-2xl max-md:text-[12px]">PORTFOLIO</h1>
      </div>
