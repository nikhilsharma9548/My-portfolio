...
const Hero = () => {  
    return (
      ...
      <section id='Home' className="h-screen flex md:pt-14 flex-col max-md:justify-center items-center bg-gradient-to-r from-gray-200 to-gray-700 text-black text-center ">
