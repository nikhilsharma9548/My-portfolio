...
const Hero = () => {  
    return (
      ...
      <section id='Home' className=" h-screen md:h-auto xl:mt-20 flex md:pt-14 pb-10 flex-col max-md:justify-center items-center bg-gradient-to-r from-gray-200 to-gray-700 text-black text-center ">
  
         <div className=" md:mt-0 md:w-1/2 flex justify-center">
        <img
          src={img1}
          alt="Nikhil"
          className="w-48 h-48 md:w-52 md:h-52 rounded-full shadow-sm border-2 mt-20 shadow-white object-cover hover:scale-105 transition duration-300"
        />
      </div>
