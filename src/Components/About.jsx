...
const About = () => {
  return ( 
    <section id='About' className=" w-full  h-full flex-col md:flex-row  pt-10 overflow-hidden bg-gradient-to-r from-gray-200 to-gray-700">
  <h1 className=' text-4xl md:text-3xl text-center font-bold mb-6'>ABOUT-ME</h1>

  <div className='flex flex-col xl:flex-row  justify-center  gap-10 md:gap-28 px-4'>
    ...
    <div className='xl:w-[60%] w-full flex flex-col justify-center items-center gap-6 mt-6 md:mt-0'>

      <h1 className="text-center max-xl:w-[70%] sm:text-lg md:text-xl xl:mt-0 leading-relaxed ">
      ...
      <div className='flex flex-col   md:flex-row items-center md:items-start gap-6 mt-5 md:gap-10'>
