...
const About = () => {
  ...
  className=' text-3xl text-center font-semibold pb-10'>ABOUT-ME</motion.h1>
  ...
  <div className='flex flex-col xl:flex-row  justify-center  gap-5  px-4'>
    ...
    >
      <img
        src={image4}
        alt="Nikhil"
        className="w-60 h-80 md:w-68  rounded-3xl shadow-lg mt-10 sm:mt-5 border-gray-400 object-cover hover:scale-105 transition duration-500 "
      />
    </motion.div>
    ...
    <div className='xl:w-[60%] w-full flex flex-col justify-center items-center gap-14 '>
      ...
      whileInView={{opacity:1,translateX:0}}
      transition={{duration:0.7}}
      className="sm:pl-10 pl-5 md:text-lg text-start max-xl:w-[72vw] leading-relaxed ">
      ...
      className='flex flex-col pb-5 md:w-[90%] justify-center lg:w-full md:flex-row items-center md:items-start gap-6 md:gap-10'>
        ...
        <motion.div className='w-72 h-44 xl:h-40 xl:w-60 bg-transparent  border rounded-lg transition-all  duration-500 hover:-translate-y-1  hover:shadow-[5px_5px_2px_rgba(0,0,0,7)] hover:shadow-red-600/70'
        ...
        <motion.div className='w-72 h-44 xl:h-40 xl:w-60 bg-transparent border rounded-lg  duration-500 hover:-translate-y-1 hover:shadow-[5px_5px_2px_rgba(0,0,0,7)]  hover:shadow-red-600/70'
        initial={{opacity:0,translateX:300}}
        whileInView={{opacity:1,translateX:0}}
        transition={{duration:0.3}}
