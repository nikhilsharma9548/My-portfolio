    ...
    <section id='About' className="h-full pt-40 overflow-hidden bg-gradient-to-r from-gray-200 to-gray-700">
      ...
      <div className='flex max-md:flex-col  justify-center w-full items-center gap-32 relative right-32'>
                    <div className="flex justify-center md:justify-end w-full  md:w-1/2">
                      ...
                      src={image4}
                      alt="Nikhil"
                        className="w-72 h-96 max-md:relative left-32 md:w-96 md:h-[470px] rounded-3xl shadow-lg border-4 mt-20 border-gray-400 object-cover hover:scale-105 transition duration-300  cursor-pointer"
                       />
                   </div>
                   ...
                   <div className='w-full md:w-[80%] max-md:flex-col  justify-center md:justify-start items-center'>
                    ...
                    max-md:left-[11.5rem] max-md:bottom-10 max-md:text-balance  '>
                      ...
                      <div className='h-52 w-72 bg-transparent  border-2 rounded-lg transition-all duration-500 hover:scale-105  '>
                      ...
                      <div className='h-52 w-72 bg-transparent border-2 rounded-lg transition-all duration-500 hover:scale-105  '>
                        ...
                        <h1 className='text-xl p-3 mx-3 opacity-1'>Bachelor of Computer Applications(BCA)[Present]</h1>
                      </div>

                      <div className='h-52 w-72 bg-transparent  border-2 rounded-lg transition-all duration-500 hover:scale-105 '>
                        <p className='text-5xl px-6 pt-6'><VscFileSubmodule /></p>
                        <h1 className='px-5 pt-2 text-xl'>Projects</h1>
                        <h1 className='text-xl p-4 mx-3 opacity-'>Built more than 5 projects</h1>
                      </div>
