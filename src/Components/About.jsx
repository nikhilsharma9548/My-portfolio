...
const About = () => {
  return ( 
    <section id='About' className="h-screen pt-40  bg-gradient-to-r from-gray-200 to-gray-700">
      ...
      <div className='flex  justify-center w-full items-center gap-32 relative right-32'>
                    <div className="flex justify-center md:justify-end w-full md:w-1/2">
                       <img
                      src={image4}
                      alt="Nikhil"
                        className="w-64 h-80 md:w-96 md:h-[470px] rounded-3xl shadow-lg border-4 mt-20 border-gray-400 object-cover"
                       />
                   </div>

                   <div className='w-full md:w-[80%]  justify-center md:justify-start items-center'>
