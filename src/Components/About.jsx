...
const About = () => {
  return ( 
    <section id='About' className=" w-full h-auto flex-col md:flex-row justify-center pt-10 overflow-hidden bg-gradient-to-r from-gray-200 to-gray-700">
  <h1 className=' text-4xl md:text-3xl text-center font-bold mb-6'>ABOUT-ME</h1>

  <div className='flex flex-col md:flex-row  justify-center  gap-10 md:gap-32 px-4'>
    
    <div className="flex justify-center w-full md:w-auto">
      <img
        src={image4}
        alt="Nikhil"
        className="w-60 h-80 md:w-68 md:h-80 rounded-3xl shadow-lg mt-10 md:mt-20 border-gray-400 object-cover hover:scale-105 transition duration-500 cursor-pointer"
      />
    </div>

    <div className='w-full md:w-1/2 flex flex-col justify-center items-center gap-6 mt-6 md:mt-0'>
      <h1 className="text-center md:text-left text-base sm:text-lg md:text-xl leading-relaxed px-2">
      ...
      <div className='flex flex-col  md:flex-row justify-center items-center md:items-start gap-6 md:gap-10'>
        <div className='h-48 w-64 bg-transparent  border-2 rounded-lg transition-all duration-500 hover:scale-105 hover:border-b-8 hover:border-r-8 hover:border-red-600'>
          <p className='text-4xl p-4'><FaCode /></p>
          <p className='px-4 pt-2 text-lg xl:text-xl  '>Languages</p>
          <p className='text-lg p-3 mx-3 xl:text-xl'>HTML, CSS, JavaScript, ReactJS, TailwindCSS</p>
        </div>
