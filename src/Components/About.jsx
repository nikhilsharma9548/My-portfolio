...
const About = () => {
  ...
  <div className='flex flex-col xl:flex-row  justify-center  gap-5  px-4'>
    ...
    <div className='xl:w-[60%] w-full flex flex-col justify-center items-center gap-14 '>
      <h1 className="text-center sm:text-lg md:text-xl max-xl:w-[70vw] pt-20 leading-relaxed ">
      ...
      <div className='flex flex-col pb-5 md:w-[90%] justify-center lg:w-full md:flex-row items-center md:items-start gap-6 md:gap-10 pt-5'>
